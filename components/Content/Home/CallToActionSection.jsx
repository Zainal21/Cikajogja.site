export default function CallToAction(props) {
   return (
      <div className="container">
        <div className="relative z-10 overflow-hidden rounded bg-warning py-12 px-8 md:p-[70px]">
          <div className="mx-4 flex flex-wrap items-center">
            <div className="w-full px-4 lg:w-1/2">
              <span className="mb-2 text-base font-semibold text-white">
                Interested to have a project with us?
              </span>
            ...
            <div className="w-full px-4 lg:w-1/2">
              <div className="flex flex-wrap lg:justify-end">
                <a href="#"
                  className="my-1 mr-4 inline-block rounded bg-white bg-opacity-[15%] py-4 px-6 text-base font-medium text-white transition hover:shadow-lg hover:text-warning md:px-9 lg:px-6 xl:px-9">
                  Lets Talk
                </a>
              </div>
            </div>
