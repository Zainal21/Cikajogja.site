...
export default function Service(props) {
  return (
    <div className="container">
      <SectionTitle
        titleHint=" Our Services"
        titleMain="What We Offer"
        titleDescription="We provide high quality, professional tech services to help you optimize your business"
      />
      <div className="-mx-4 flex flex-wrap">
        <ServiceCard
          ServiceName="Mobile Development"
          serviceDescription="We build your customized mobile app for both Android Apps with the latest technology stack."
          ServiceIcon={
            <svg
              width="32"
              height="32"
