         ...
         <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 lg:w-5/12">
               ...
               <h1 className="mb-3 text-4xl font-bold leading-snug text-dark sm:text-[42px] lg:text-[40px] xl:text-[42px]">
                  CV.Cipta <span className="text-red-600">Karya Abadi</span><br />
               </h1>
               <p className="mb-8 max-w-[480px] text-md text-body-color">
                  <strong>CV Cipta Karya Abadi</strong> is an information technology solutions provider company based in Sleman D.I Yogyakarta. We've been in the works since July 2012. You Want IT, We Make IT !!!, Independent Consultant With IT Based Implementation
               </p>
